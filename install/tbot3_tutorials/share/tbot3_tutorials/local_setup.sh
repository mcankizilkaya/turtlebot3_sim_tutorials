...
: ${AMENT_CURRENT_PREFIX:="/turtlebot3_ws/src/turtlebot3_simulations/tbot3_tutorials/install/tbot3_tutorials"}
...
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tbot3_tutorials/environment/ament_prefix_path.sh"
ament_append_value AMENT_ENVIRONMENT_HOOKS "$AMENT_CURRENT_PREFIX/share/tbot3_tutorials/environment/path.sh"
